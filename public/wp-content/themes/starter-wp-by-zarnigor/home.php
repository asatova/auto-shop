    ...
    <section class="benefits">
        <div class="container">
            <div class="benefits__inner">
                <img data-wow-delay="2s" class="benefits__images wow animate__fadeInUp" src="<?php bloginfo('template_url'); ?>/assets/imagescar.png" alt="car">
...
<!--                                <img class="carousel__item-img" src=""/>-->
